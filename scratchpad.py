...
tokenizer = AutoTokenizer.from_pretrained("mrm8488/squeezebert-finetuned-squadv2")
model = AutoModelForQuestionAnswering.from_pretrained("mrm8488/squeezebert-finetuned-squadv2")
